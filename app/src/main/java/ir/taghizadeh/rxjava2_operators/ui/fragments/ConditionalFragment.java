...
public class ConditionalFragment extends Fragment {
    ...
    @BindView(R.id.rv_conditional)
    RecyclerView rv_conditional;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_conditional, container, false);
    ...
    private void initRecyclerView() {
        rv_conditional.setLayoutManager(new LinearLayoutManager(getActivity()));
